      ...
      <div class="row">
        ...
        <div class="col-md-5 ml-auto">
          <div class="p-4 border mb-3">
            <span class="d-block text-primary h6 text-uppercase"><i class="fa-solid fa-location-dot mr-2"></i>Colleger Breyer Gombak</span>
           </div>
          <div class="p-4 border mb-3">
            <span class="d-block text-primary h6 text-uppercase"><i class="fa-solid fa-phone mr-2"></i> 603-61854643</span>
          </div>
          <div class="p-4 border mb-3">
            <span class="d-block text-primary h6 text-uppercase"><i class="fa-solid fa-envelope mr-2"></i>enquiry.sg@breyer.edu.my</span>
           </div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">BreyerStore</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
        <h5>Scan Qr Code To Make Payments.</h5>
        <h5>After You make Payment You Can Click This Link To Get Details Info About Your Purchase</h5>
        <a class="btn btn-success" href="">Whatsapp Now</a>
